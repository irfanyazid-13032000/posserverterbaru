    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                {{ Form::textarea('discover_description', $discover['discover_description'], ['class' => 'form-control summernote-simple','id' => 'classic-editor', 'placeholder' => __('Enter Description')]) }}
            </div>
        </div>
