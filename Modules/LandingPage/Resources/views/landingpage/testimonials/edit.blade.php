        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    {{ Form::textarea('testimonials_description', $testimonial['testimonials_description'], ['class' => 'form-control summernote-simple', 'id' => 'classic-editor', 'placeholder' => __('Enter Description')]) }}
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
