                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    {{ Form::textarea('testimonials_long_description', $settings['testimonials_long_description'], ['class' => 'form-control summernote-simple', 'id' => 'classic-editor', 'placeholder' => __('Enter Long Description')]) }}
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3 justify-content-end d-flex">
                                <a data-size="lg" data-url="{{ route('testimonials_create') }}" data-ajax-popup="true"
                                    data-bs-toggle="tooltip" title="{{ __('Discover Feature Create') }}"
