                                ...
                                <ul class="list-unstyled my-3">
                                    <li>
                                        <div class="form-check text-start">
                                            <input class="form-check-input input-primary" type="checkbox"
                                                id="customCheckc1"
                                                {{ $value->enable_custdomain == 'on' ? 'checked' : '' }}>
                                    ...
                                    <li>
                                        <div class="form-check text-start">
                                            <input class="form-check-input input-primary" type="checkbox"
                                                id="customCheckc2"
                                                {{ $value->enable_custsubdomain == 'on' ? 'checked' : '' }}>
                                    ...
                                    <li>
                                        <div class="form-check text-start">
                                            <input class="form-check-input input-primary" type="checkbox"
                                                id="customCheckc3"
                                                {{ $value->shipping_method == 'on' ? 'checked' : '' }}>
                                            <label class="form-check-label" for="customCheckc3">
                                                {{ __('Shipping Method') }}</label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="form-check text-start">
                                            <input class="form-check-input input-primary" type="checkbox"
                                                id="customCheckc4" {{ $value->pwa_store == 'on' ? 'checked' : '' }}>
                                            <label class="form-check-label" for="customCheckc4">
                                                {{ __('Progressive Web App ( PWA )') }}</label>
                                        </div>
                                    </li>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-3 text-center">
                                        <span class="mb-0">
                                            ...
                                            @else
                                                <span
                                                    class="h5 mb-0 {{ $key == 1 ? 'text-dark' : '' }} {{ $key == 2 ? 'text-light-primary' : '' }}">{{ $value->storage_limit }}</span>
                                            @endif
                                        </span>
                                        <span class="d-block text-sm">{{ __('Storage') }}</span>
                                    </div>
                                </div>
                                <div class="d-grid">
