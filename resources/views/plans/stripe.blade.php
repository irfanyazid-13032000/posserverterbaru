                                        ...
                                        <div class="row mt-1">
                                            <ul class="plan-detail">
                                                ...
                                                @if ($plan->storage_limit != 0)
                                                    <li>{{ __('Storage Limit : ') }}{{ $plan->storage_limit }}{{ ' KB' }}
                                                    </li>
                                                @else
                                                    <div>
                                                        {{ __('Storage Limit : ') }}{{ $plan->storage_limit }}{{ ' KB' }}
                                                    </div>
                                                @endif
                                            </ul>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="border p-3 mb-3 rounded stripe-payment-div">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label for="" class="col-form-label">{{ 'Plan Price : ' }}
                                                        <span
                                                            class="paypal-final-price">{{ env('CURRENCY_SYMBOL') . $plan->price }}</span></label>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label for=""
                                                        class="col-form-label mb-0">{{ 'Net Ammount : ' }}<span
                                                            class="final-price">{{ env('CURRENCY_SYMBOL') . $plan->price }}</span></label><br>
                                                    <small class="text-muted">{{ '(After Coupon Apply )' }}</small>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <div class="text-sm-end mr-2">
                                                    ...
                                                    <input type="submit" value="Pay Now" class="btn btn-xs btn-primary">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    @if (isset($admin_payments_details['is_paystack_enabled']) && $admin_payments_details['is_paystack_enabled'] == 'on')
                        <div id="paystack-payment" class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="col-12 text-end">
                                    <input type="button" onclick="preparePayment(this,'paystack')" value="Pay Now"
                    ...
                    @if (isset($admin_payments_details['is_flutterwave_enabled']) &&
                        ...
                        <div id="flutterwave-payment" class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="col-12 text-end">
                                    <input type="button" onclick="preparePayment(this,'flutterwave')" value="Pay Now"
                                        class="btn btn-print-invoice  btn-primary m-b-10 m-r-10">
                                </div>
                        ...
                        <div id="razorpay-payment" class="card">
                            ...
                            <div class="card-body">
                                <form class="w3-container w3-display-middle w3-card-4" method="POST" id="payment-form"
                                    ...
                                    <div class="col-12 text-end">
                                        <input type="button" onclick="preparePayment(this,'razorpay')" value="Pay Now"
                                            class="btn btn-print-invoice  btn-primary m-b-10 m-r-10">
                                    </div>
                                </form>
                            </div>
                        ...
                        <div id="mercado-payment" class="card">
                            ...
                            <div class="card-body">
                                <form class="w3-container w3-display-middle w3-card-4" method="POST" id="payment-form"
                                    ...
                                    <div class="col-12 text-end">
                                        <input type="button" onclick="preparePayment(this,'mercado')" value="Pay Now"
                                            class="btn btn-print-invoice  btn-primary m-b-10 m-r-10">
                                    </div>
                                </form>
                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label for=""
                                                            class="col-form-label">{{ 'Plan Price : ' }}
                                                            <span
                                                                class="paypal-final-price">{{ env('CURRENCY_SYMBOL') . $plan->price }}</span></label>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="form-group">
                                                            <label for=""
                                                                class="col-form-label mb-0">{{ 'Net Ammount : ' }}<span
                                                                    class="final-price">{{ env('CURRENCY_SYMBOL') . $plan->price }}</span></label><br>
                                                            <small
                                                                class="text-muted">{{ '(After Coupon Apply )' }}</small>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-12 my-2 px-2">
                                                <div class="text-end">
                                                    <input type="hidden" name="plan_id" id="plan_id"
                                                        value="{{ \Illuminate\Support\Facades\Crypt::encrypt($plan->id) }}">
                                                    <input type="submit" value="Pay Now" id="payfast-get-status"
