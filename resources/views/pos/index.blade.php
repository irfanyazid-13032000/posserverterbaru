...
<head>
  ...
  <link rel="shortcut icon" type="image/x-icon" href="{{url('assets/grocee')}}/img/favicon.ico">
    
   <!-- ======= All CSS Plugins here ======== -->
  <link rel="stylesheet" href="{{url('assets/grocee')}}/css/plugins/swiper-bundle.min.css">
  <link rel="stylesheet" href="{{url('assets/grocee')}}/css/plugins/glightbox.min.css">
  <link href="https://fonts.googleapis.com/css2?family=Lato:ital,wght@0,100;0,300;0,400;0,700;0,900;1,300;1,400;1,700;1,900&family=Lora:ital,wght@0,400;0,500;0,600;0,700;1,400;1,500;1,600;1,700&family=Poppins:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap" rel="stylesheet">

  <!-- Plugin css -->
  <link rel="stylesheet" href="{{url('assets/grocee')}}/css/vendor/bootstrap.min.css">

  <!-- Custom Style CSS -->
  <link rel="stylesheet" href="{{url('assets/grocee')}}/css/style.css">
...
<body>
            ...
            <div class="container">
                <div class="main__header--inner position__relative d-flex justify-content-between align-items-center">
                    ...
                    <div class="main__logo">
                        <h1 class="main__logo--title"><a class="main__logo--link" href="index.html"><img class="main__logo--img" src="{{url('assets/grocee')}}/img/logo/nav-log.png" alt="logo-img"></a></h1>
                    </div>
            ...
            <div class="offcanvas__inner">
                <div class="offcanvas__logo">
                    <a class="offcanvas__logo_link" href="index.html">
                        <img src="{{url('assets/grocee')}}/img/logo/nav-log.png" alt="Grocee Logo" width="158" height="36">
                    </a>
                ...
                <nav class="offcanvas__menu">
                    ...
                    <div class="offcanvas__account--currency">
                        <a class="offcanvas__account--currency__menu text-black" href="javascript:void(0)">
                            <img src="{{url('assets/grocee')}}/img/icon/usd-icon.png" alt="currency">
                            <span>USD</span> 
                            ...
                            <div class="row row-cols-lg-4 row-cols-md-3 row-cols-2 mb--n28">
                                    ...
                                    <div class="product__items product__items2">
                                        <div class="product__items--thumbnail">
                                            <a class="product__items--link" href="product-details.html">
                                                <img class="product__items--img product__primary--img" src="{{url('assets/grocee')}}/img/product/product7.png" alt="product-img">
                                                <img class="product__items--img product__secondary--img" src="{{url('assets/grocee')}}/img/product/product8.png" alt="product-img">
                                            </a>
                                ...
                                <div class="col mb-28">
                                    <div class="product__items product__items2">
                                        <div class="product__items--thumbnail">
                                            <a class="product__items--link" href="product-details.html">
                                                <img class="product__items--img product__primary--img" src="{{url('assets/grocee')}}/img/product/product2.png" alt="product-img">
                                                <img class="product__items--img product__secondary--img" src="{{url('assets/grocee')}}/img/product/product1.png" alt="product-img">
                                            </a>
                                            <div class="product__badge">
                                                <span class="product__badge--items sale">Sale</span>
                                            </div>
                                ...
                                <div class="col md-28">
                                    <div class="product__items product__items2">
                                        <div class="product__items--thumbnail">
                                            <a class="product__items--link" href="product-details.html">
                                                <img class="product__items--img product__primary--img" src="{{url('assets/grocee')}}/img/product/product1.png" alt="product-img">
                                                <img class="product__items--img product__secondary--img" src="{{url('assets/grocee')}}/img/product/product2.png" alt="product-img">
                                            </a>
                                            <div class="product__badge">
                                                <span class="product__badge--items sale">Sale</span>
                                            </div>
                                ...
                                <div class="col mb-28">
                                    <div class="product__items product__items2">
                                        <div class="product__items--thumbnail">
                                            <a class="product__items--link" href="product-details.html">
                                                <img class="product__items--img product__primary--img" src="{{url('assets/grocee')}}/img/product/product3.png" alt="product-img">
                                                <img class="product__items--img product__secondary--img" src="{{url('assets/grocee')}}/img/product/product4.png" alt="product-img">
                                            </a>
                                            <div class="product__badge">
                                                <span class="product__badge--items sale">Sale</span>
                                            </div>
                                ...
                                <div class="col mb-28">
                                    <div class="product__items product__items2">
                                        <div class="product__items--thumbnail">
                                            <a class="product__items--link" href="product-details.html">
                                                <img class="product__items--img product__primary--img" src="{{url('assets/grocee')}}/img/product/product4.png" alt="product-img">
                                                <img class="product__items--img product__secondary--img" src="{{url('assets/grocee')}}/img/product/product3.png" alt="product-img">
                                            </a>
                                            <div class="product__badge">
                                                <span class="product__badge--items sale">Sale</span>
                                            </div>
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="quickview__thumb">
                                        <a class="quickview__thumb--link" href="product-details.html"><img class="quickview__thumb--img" src="{{url('assets/grocee')}}/img/product/big-product1.jpg" alt="product-img"></a>
                                        <div class="product__badge">
                                            <span class="product__badge--items sale">Sale</span>
                                        </div>
                                    </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="quickview__thumb">
                                        <a class="quickview__thumb--link" href="product-details.html"><img class="quickview__thumb--img" src="{{url('assets/grocee')}}/img/product/big-product2.jpg" alt="product-img"></a>
                                        <div class="product__badge">
                                            <span class="product__badge--items sale">Sale</span>
                                        </div>
                                    </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="quickview__thumb">
                                        <a class="quickview__thumb--link" href="product-details.html"><img class="quickview__thumb--img" src="{{url('assets/grocee')}}/img/product/big-product3.jpg" alt="product-img"></a>
                                        <div class="product__badge">
                                            <span class="product__badge--items sale">Sale</span>
                                        </div>
                                    </div>
                                        ...
                                        <fieldset class="variant__input--fieldset">
                                            ...
                                            <div class="variant__color d-flex">
                                                <div class="variant__color--list">
                                                    ...
                                                    <label class="variant__color--value red" for="color-red5" title="Red"><img class="variant__color--value__img" src="{{url('assets/grocee')}}/img/product/product1.png" alt="variant-color-img"></label>
                                                </div>
                                                <div class="variant__color--list">
                                                    <input id="color-red6" name="color" type="radio">
                                                    <label class="variant__color--value red" for="color-red6" title="Black"><img class="variant__color--value__img" src="{{url('assets/grocee')}}/img/product/product2.png" alt="variant-color-img"></label>
                                                </div>
                                                <div class="variant__color--list">
                                                    <input id="color-red7" name="color" type="radio">
                                                    <label class="variant__color--value red" for="color-red7" title="Pink"><img class="variant__color--value__img" src="{{url('assets/grocee')}}/img/product/product3.png" alt="variant-color-img"></label>
                                                </div>
                                                <div class="variant__color--list">
                                                    <input id="color-red8" name="color" type="radio">
                                                    <label class="variant__color--value red" for="color-red8" title="Orange"><img class="variant__color--value__img" src="{{url('assets/grocee')}}/img/product/product4.png" alt="variant-color-img"></label>
                                                </div>
                                            </div>
                                        </fieldset>
                                    </div>
  ...
  <!-- All Script JS Plugins here  -->
   <script src="{{url('assets/grocee')}}/js/vendor/popper.js" defer="defer"></script>
