        ...
        @else
            ...
            <li class="nav-item">
                <a class="nav-link" id="store_email_settings-tab" data-bs-toggle="pill" href="#store_email_settings"
                    ...
                    aria-selected="false">{{ __('Email Notification Settings') }}</a>
            </li>
            <li class="nav-item">
                                            ...
                                            <div class="card-body admin_favicon pt-6">
                                                <div class=" setting-card">
                                                    <div class="logo-content mt-4">
                                                        ...
                                                        <a href="{{ $logo . (isset($logo) && !empty($logo) ? $logo : 'favicon.png') . '?timestamp=' . time() }}"
                                                            target="_blank">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-6 form-group">
                                                        ...
                                                        <input type="text" name="currency_symbol" class="form-control"
                                                            id="currency_symbol" value="{{ env('CURRENCY_SYMBOL') }}"
                                                            required>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="form-group">
                                            {{ Form::text('chatgpt_key', isset($settings['chatgpt_key']) ? $settings['chatgpt_key'] : '', ['class' => 'form-control', 'placeholder' => __('Enter Chat GPT Key Here')]) }}
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="col-4 my-auto">
                                                ...
                                                <div class="form-check form-switch">
                                                    <input type="checkbox" class="form-check-input"
                                                        ...
                                                        {{ $setting['cust_darklayout'] == 'on' ? 'checked="checked"' : '' }} />
                                                    <label class="form-check-label f-w-600 pl-1"
                                                        for="cust-darklayout">{{ __('Dark Layout') }}</label>
                                                </div>
                                            </div>
