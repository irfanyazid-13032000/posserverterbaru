<div class="modal-body">
    <div class="product-view-body">
        {{-- <form method="POST" action="https://demo.rajodiya.com/whatsstore-saas/my-whatsstore/customer-login" accept-charset="UTF-8" class="login-form-main"><input name="_token" type="hidden" value="CTe9lqYafL8ynU4ctpHU3BXOQPqLx4bIFOvADMFt"> --}}
