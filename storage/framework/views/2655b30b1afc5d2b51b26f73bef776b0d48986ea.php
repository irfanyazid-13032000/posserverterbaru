                    ...
                    <form action="<?php echo e(route('category.update',['id'=>$category->id])); ?>" method="POST" >
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="name_category" name="name_category"
                                value="<?php echo e($category->name_category); ?>" required>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="warehouse_id" name="warehouse_id"
                                ...
                                <?php $__currentLoopData = $warehouses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $warehouse): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                  <?php if($warehouse->id == $category->warehouse_id): ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\posserverterbaru\resources\views/category/edit-category.blade.php ENDPATH**/ ?>