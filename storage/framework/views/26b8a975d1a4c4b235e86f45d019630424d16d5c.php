  ...
  <h4 class="fw-bold py-3 mb-4">Data Customer</h4>
    <div class="card">
        <div class="table-responsive text-nowrap p-4">
            <table class="table table-hover" id="table">
                ...
                <tbody class="table-border-bottom-0" id="table">
                  ...
                  <tr class="text-center">
                    ...
                    <td><?php echo e($customer->name_customer); ?></td>
                    <td><?php echo e($customer->no_telp); ?></td>
                    <td>
                      <a href="<?php echo e(route('customer.edit',['id'=>$customer->id])); ?>" class="btn btn-primary">edit</a>
                      <a href="<?php echo e(route('customer.destroy',['id'=>$customer->id])); ?>" class="btn btn-danger">delete</a>
                    </td>
                 </tr>
            ...
            <a href="<?php echo e(route('customer.create')); ?>" class="btn btn-success">Add</a>
        </div>
    </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\posserverterbaru\resources\views/customer/index-customer.blade.php ENDPATH**/ ?>