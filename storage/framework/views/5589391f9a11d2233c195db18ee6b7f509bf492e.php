            ...
            <?php else: ?>
                ...
                <li
                    ...
                    <ul
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Manage Products')): ?>
                            <li class="dash-item <?php echo e(Request::route()->getName() == 'roles' ? ' active' : ''); ?>">
                                <a class="dash-link" href="<?php echo e(route('purchase.index')); ?>">Purchase List</a>
                            </li>
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Manage User')): ?>
                ...
                <li
                    ...
                    <ul
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Manage Products')): ?>
                            <li class="dash-item <?php echo e(Request::route()->getName() == 'roles' ? ' active' : ''); ?>">
                                <a class="dash-link" href="<?php echo e(route('food.index')); ?>">Food Process</a>
                            </li>
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Manage User')): ?>
                ...
                <li
                    ...
                    <a href="#!" class="dash-link ">
                        ...
                        <span class="dash-mtext">Bahan</span>
                        <span class="dash-arrow">
                            <i data-feather="chevron-right"></i>
                        </span>
                    </a>
...
<?php /**PATH C:\laragon\www\posserverterbaru\resources\views/partials/admin/menu.blade.php ENDPATH**/ ?>