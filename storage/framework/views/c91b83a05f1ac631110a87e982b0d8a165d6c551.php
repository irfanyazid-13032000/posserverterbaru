...
<head>
  ...
  <link rel="shortcut icon" type="image/x-icon" href="<?php echo e(asset('assets/grocee')); ?>/img/favicon.ico">
    
   <!-- ======= All CSS Plugins here ======== -->
  <link rel="stylesheet" href="<?php echo e(asset('assets/grocee')); ?>/css/plugins/swiper-bundle.min.css">
  <link rel="stylesheet" href="<?php echo e(asset('assets/grocee')); ?>/css/plugins/glightbox.min.css">
  <link href="https://fonts.googleapis.com/css2?family=Lato:ital,wght@0,100;0,300;0,400;0,700;0,900;1,300;1,400;1,700;1,900&family=Lora:ital,wght@0,400;0,500;0,600;0,700;1,400;1,500;1,600;1,700&family=Poppins:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap" rel="stylesheet">

  <!-- Plugin css -->
  <link rel="stylesheet" href="<?php echo e(asset('assets/grocee')); ?>/css/vendor/bootstrap.min.css">

  <!-- Custom Style CSS -->
  <link rel="stylesheet" href="<?php echo e(asset('assets/grocee')); ?>/css/style.css">
...
<body>
            ...
            <div class="checkout__page--inner d-flex">
                <div class="main checkout__mian">
                    <header class="main__header checkout__mian--header mb-30">
                        <a class="logo logo__left mb-20" href="index.html"><img src="<?php echo e(asset('assets/grocee')); ?>/img/logo/nav-log.png" alt="logo"></a>
                        <details class="order__summary--mobile__version">
                            <summary class="order__summary--toggle border-radius-5">
                                <span class="order__summary--toggle__inner">
                                    ...
                                    <span class="order__summary--final__price">Rp. <?php echo e(number_format($total_cart_price)); ?></span>
                                </span>
                            </summary>
                                                ...
                                                <td class=" summary__table--list">
                                                    <div class="cart__product d-flex align-items-center">
                                                        <div class="product__thumbnail border-radius-5">
                                                            <a href="product-details.html"><img class="border-radius-5" src="<?php echo e(asset('assets/grocee')); ?>/img/product/small-product4.png" alt="cart-product"></a>
                                                            <span class="product__thumbnail--quantity">1</span>
                                                        </div>
                                                        <div class="product__description">
                                                            <h3 class="product__description--name h4"><a href="product-details.html"><?php echo e($cart->name_product); ?></a></h3>
                                                            <span class="product__description--variant">COLOR: White</span>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class=" summary__table--list">
                                                    <span class="cart__price">Rp. <?php echo e(number_format($cart->price)); ?></span>
                                                </td>
                                            </tr>
                                    ...
                                    <table class="checkout__total--table">
                                        <tfoot class="checkout__total--footer">
                                            <tr class="checkout__total--footer__items">
                                                ...
                                                <td class="checkout__total--footer__amount checkout__total--footer__list text-right">Rp. <?php echo e(number_format($total_cart_price)); ?></td>
                                            </tr>
                                        </tfoot>
                                    </table>
                                </div>
                    ...
                    <main class="main__content_wrapper">
                        <form action="<?php echo e(route('create.receipt')); ?>" method="POST">
                          <?php echo csrf_field(); ?>
                            ...
                            <div class="checkout__content--step section__shipping--address">
                                ...
                                <div class="checkout__content--step__inner3 border-radius-5">
                                    <div class="checkout__address--content__header d-flex align-items-center justify-content-between">
                                        ...
                                        <span class="heckout__address--content__icon"><img src="<?php echo e(asset('assets/grocee')); ?>/img/icon/credit-card.svg" alt="card"></span>
                                    </div>
                                ...
                                <tr class="cart__table--body__items">
                                    <td class="cart__table--body__list">
                                        <div class="product__image two  d-flex align-items-center">
                                            <div class="product__thumbnail border-radius-5">
                                                <a href="product-details.html"><img class="border-radius-5" src="<?php echo e(asset('storage/product_images')); ?>/<?php echo e($cart->image); ?>" alt="cart-product"></a>
                                                <span class="product__thumbnail--quantity"><?php echo e($cart->qty); ?></span>
                                            </div>
                                            <div class="product__description">
                                                <h3 class="product__description--name h4"><a href="product-details.html"><?php echo e($cart->name_product); ?></a></h3>
                                            </div>
                                    ...
                                    <td class="cart__table--body__list">
                                        <span class="cart__price">Rp. <?php echo e(number_format($cart->total_price)); ?></span>
                                    </td>
                                </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <input type="hidden" name="total_cart_price" value="<?php echo e($total_cart_price); ?>" id="total_cart_price">
  ...
  <!-- All Script JS Plugins here  -->
   <script src="<?php echo e(asset('assets/grocee')); ?>/js/vendor/popper.js" defer="defer"></script>
   <script src="<?php echo e(asset('assets/grocee')); ?>/js/vendor/bootstrap.min.js" defer="defer"></script>
   <script src="<?php echo e(asset('assets/grocee')); ?>/js/plugins/swiper-bundle.min.js"></script>
   <script src="<?php echo e(asset('assets/grocee')); ?>/js/plugins/glightbox.min.js"></script>
   <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>

   <!-- Customscript js -->
   <script src="<?php echo e(asset('assets/grocee')); ?>/js/script.js"></script>
   ...
   <script>
    ...
    function struk(params = 0) {
        ...
        $.ajax({
                type: 'POST',
                url: '<?php echo e(route("pos.struk")); ?>', // Ganti dengan URL yang sesuai
                data: { 
                    _token: csrfToken,
...
</html><?php /**PATH C:\laragon\www\posserverterbaru\resources\views/pos/checkout.blade.php ENDPATH**/ ?>