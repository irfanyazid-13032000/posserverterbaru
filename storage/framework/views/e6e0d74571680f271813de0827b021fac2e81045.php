    ...
    <section class="subscription bg-primary section-gap" id="plan">
        <div class="container">
            ...
            <div class="row justify-content-center">
                ...
                <?php
                    $collection = \App\Models\Plan::take(2)
                        ->orderBy('price', 'ASC')
                        ->get();
                ?>
                                ...
                                <ul class="list-unstyled my-3">
                                    <li>
                                        <div class="form-check text-start">
                                            <input class="form-check-input input-primary" type="checkbox"
                                                id="customCheckc1"
                                                <?php echo e($value->enable_custdomain == 'on' ? 'checked' : ''); ?>>
                                    ...
                                    <li>
                                        <div class="form-check text-start">
                                            <input class="form-check-input input-primary" type="checkbox"
                                                id="customCheckc2"
                                                <?php echo e($value->enable_custsubdomain == 'on' ? 'checked' : ''); ?>>
                                    ...
                                    <li>
                                        <div class="form-check text-start">
                                            <input class="form-check-input input-primary" type="checkbox"
                                                id="customCheckc3"
                                                <?php echo e($value->shipping_method == 'on' ? 'checked' : ''); ?>>
                                            <label class="form-check-label" for="customCheckc3">
                                                <?php echo e(__('Shipping Method')); ?></label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="form-check text-start">
                                            <input class="form-check-input input-primary" type="checkbox"
                                                id="customCheckc4" <?php echo e($value->pwa_store == 'on' ? 'checked' : ''); ?>>
                                            <label class="form-check-label" for="customCheckc4">
                                                <?php echo e(__('Progressive Web App ( PWA )')); ?></label>
                                        </div>
                                    </li>
                                    ...
                                    <li>
                                        <div class="form-check text-start">
                                            ...
                                            <label class="form-check-label" for="customCheckc5">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-3 text-center">
                                        <span class="mb-0">
                                            ...
                                            <?php else: ?>
                                                <span
                                                    class="h5 mb-0 <?php echo e($key == 1 ? 'text-dark' : ''); ?> <?php echo e($key == 2 ? 'text-light-primary' : ''); ?>"><?php echo e($value->storage_limit); ?></span>
                                            <?php endif; ?>
                                        </span>
                                        <span class="d-block text-sm"><?php echo e(__('Storage')); ?></span>
                                    </div>
                                </div>
                                <div class="d-grid">
...
<?php /**PATH C:\laragon\www\posserverterbaru\Modules/LandingPage\Resources/views/layouts/landingpage.blade.php ENDPATH**/ ?>