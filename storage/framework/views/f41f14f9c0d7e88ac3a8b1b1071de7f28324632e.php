                        ...
                        <div class="banner-tab-left-inner">
                            ...
                            <ul class="cat-tab tabs  pro_category">
                                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li data-href="<?php echo e($loop->iteration); ?><?php echo str_replace(' ', '_', $category); ?>"
                    ...
                    success: function(response) {
                        if (response.status == "Success") {
                            ...
                            if ('carttotal' in response) {
                                // var data = data['items'];
                                console.log(site_currency_symbol_position);
...
<?php /**PATH /home/touramin/public_html/sem/resources/views/storefront/theme_1_to_6/index.blade.php ENDPATH**/ ?>