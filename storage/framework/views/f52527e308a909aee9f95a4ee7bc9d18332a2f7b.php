...
<div class="col-md-12">
            <div class="card mb-4">
                <h5 class="card-header">Tambah Data Item</h5>
                <div class="card-body">
                    <form action="<?php echo e(route('item.store')); ?>" method="POST" enctype="multipart/form-data" >
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="code_item" name="code_item"
                                value="<?php echo e(old('code_item')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="name_item" name="name_item"
                                value="<?php echo e(old('name_item')); ?>" required>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\posserverterbaru\resources\views/item/create-item.blade.php ENDPATH**/ ?>